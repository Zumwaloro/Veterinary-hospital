    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
            ...
            <ul class="navbar-nav mr-auto">
                    <li class="nav-item active" id="menu-item-wrapper">
                        <a class="nav-link" id="menu-item" @click="$emit('retrieve-clients')">Clients <span class="sr-only"></span></a>
                    </li>
                </ul>
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active" id="menu-item-wrapper">
                        <router-link class="nav-link" id="menu-item" @click="logout" to="/">Log out <span class="sr-only"></span></router-link>
                    </li>
                </ul>
            </div>
    </nav>    
